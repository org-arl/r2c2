...
class SentuatorsComponent
    ...
    render() {
        ...
        this.state.actuators.forEach((actuatorObject, i) => {
            ...
            actuatorRows.push(
                <ListGroup.Item key={i} action onClick={() => {
                    this.sentuatorClicked(actuatorObject.actuator.type)
                }}>
        ...
        this.state.sensors.forEach((sensorObject, i) => {
            ...
            sensorRows.push(
                <ListGroup.Item key={i} action onClick={() => {
                    this.sentuatorClicked(sensorObject.sensor.type)
                }}>
            ...
            <Container>
                ...
                <Row>
                    <div>
                        ...
                        <div>
                            <ul>{this.state.sentuatorValue.map(value => <li key={value}>{value}</li>)}</ul>
                        </div>
                    </div>
                </Row>
            </Container>
